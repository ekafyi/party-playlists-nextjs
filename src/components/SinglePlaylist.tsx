import { AnimatePresence, motion } from "framer-motion"; // eslint-ignore
  ...
  return (
    <AnimatePresence>
      <motion.main
        ...
        layout
        // ? Only works for enter transition (Home -> Playlist)
      ...
      >
        ...
        <motion.header initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={TITLE_TRANSITION} className="pb-4">
        ...
        <motion.section
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.4, delay: 0.5, staggerChildren: 0.5 }}
